-- Seed service catalog (matches website ?service= slugs)
-- SQLite: run after schema.sqlite.sql

INSERT OR IGNORE INTO service_types (slug, name, subtitle, sort_order) VALUES
